...
public class CryptoManager { 
    ...
    public static void main(String[] args) {
    	...
    	System.out.println(vigenereEncryptedText);
    	if (vigenereEncryptedText != null)
    		System.out.println(vigenereDecryption(vigenereEncryptedText, "LEMON"));
    	...
    	if (caesarEncryptedText != null)
    		System.out.println(caesarDecryption(caesarEncryptedText, 3));
    	
    	String playfairEncryptedText = playfairEncryption("HIDE THE GOLD", "MONARCHY");
    	System.out.println(playfairEncryptedText);
    	if (playfairEncryptedText != null)
    		System.out.println(playfairDecryption(playfairEncryptedText, "MONARCHY"));
    	
    	String playfairEncryptedText2 = playfairEncryption("JACK O'S LANTERN", "APPLE");
    	System.out.println(playfairEncryptedText2);
    	if (playfairEncryptedText2 != null)
    		System.out.println(playfairDecryption(playfairEncryptedText2, "APPLE"));
    }
    ...
    public static String vigenereEncryption(String plainText, String key) {
    	...
    	while (fullKey.length() != plainText.length()) {
    		if (plainText.charAt(count) < 'A' || 'Z' < plainText.charAt(count)) 
    			// Avoid putting key at non-letter character spot.
    			fullKey += ' ';
    		else 
    			// Repeat for full key.
    	...
    	// Encryption process.
    	for (int i=0; i<plainText.length(); i++) {
    		// Skip over non-letter character and add them as they are to encrypted text.
    		if (plainText.charAt(i) < 'A' || 'Z' < plainText.charAt(i)) {
    		...
    		result += ALPHABET64.charAt((p+k) % 26);
    	}
    ...
    public static String vigenereDecryption(String encryptedText, String key) {
    	...
    	while (fullKey.length() != encryptedText.length()) {
    		if (encryptedText.charAt(count) < 'A' || 'Z' < encryptedText.charAt(count)) 
    			// Avoid putting key at non-letter character spot.
    			fullKey += ' ';
    		else 
    			// Repeat for full key.
    	...
    	for (int i=0; i<encryptedText.length(); i++) {
    		// Skip over non-letter character and add them as they are to decrypted text.
    		if (encryptedText.charAt(i) < 'A' || 'Z' < encryptedText.charAt(i)) {
    		...
    		result += ALPHABET64.charAt((e-k+26) % 26);
    	}
